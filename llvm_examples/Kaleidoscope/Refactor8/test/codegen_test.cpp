...
// theJIT is never created -- so the JIT execution tests that earlier chapters
// carry were removed here: they dereferenced a null unique_ptr and crashed.
// JIT behavior remains covered by the Refactor4-7 test suites; this chapter's
// end-to-end coverage is the object-file emission test in test/filecheck/objfile.k.
